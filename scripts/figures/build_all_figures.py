...
BOUNDARY_ERROR_DIR = REPO_ROOT / "analysis" / "boundary_error"
...
def run_analysis(script_name: str, produced: str, final_name: str) -> bool:
    ...
    src = BOUNDARY_ERROR_DIR / produced
...
def main() -> None:
    ...
    # The five figures shipped in the manuscript, written directly to figures/ (descriptive
    # names; LaTeX assigns the printed numbers). oem_mapping's numeric content is generated by
    # _gen_mapping_values.py from the frozen teacher confusion. Exploratory figures not in the
    # paper (workflow_pipeline, class_distributions, ablation_qualitative, boundary_limited_error)
    # keep their scripts under scripts/ and can still be run by hand.
